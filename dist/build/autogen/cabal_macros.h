...
/* package aeson-0.11.1.4 */
#define VERSION_aeson "0.11.1.4"
...
/* package happstack-foundation-0.5.9 */
#define VERSION_happstack_foundation "0.5.9"
#define MIN_VERSION_happstack_foundation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 9)

/* package happstack-server-7.4.6.1 */
#define VERSION_happstack_server "7.4.6.1"
#define MIN_VERSION_happstack_server(major1,major2,minor) (\
  (major1) <  7 || \
  (major1) == 7 && (major2) <  4 || \
  (major1) == 7 && (major2) == 4 && (minor) <= 6)
...
/* package persistent-template-2.1.6 */
#define VERSION_persistent_template "2.1.6"
...
#define CURRENT_PACKAGE_KEY "Cloud_9jhcdGR0bG94adP6NhCVsn"
